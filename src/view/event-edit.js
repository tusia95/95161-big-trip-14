import {formatTypeWithPreposition, formatDate} from '../mock/utils';
import {generateIsFavorite} from '../mock/event';
export const createEventEditTemplate = (tripPoint, destinations, types) => {
  return (
    `<li class="trip-events__item">
        ...
        <input class="event__type-toggle  visually-hidden" id="event-type-toggle-1" type="checkbox" ${generateIsFavorite()}>
